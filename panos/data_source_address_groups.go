...
func dataSourceAddressGroups() *schema.Resource {
	...
	return &schema.Resource{
		Read: dataSourceAddressGroupsRead,

		Schema: s,
	}
}

func dataSourceAddressGroupsRead(d *schema.ResourceData, meta interface{}) error {
	var err error
	var listing []string
	var id string
	...
	case *pango.Firewall:
		...
		listing, err = con.Objects.AddressGroup.GetList(id)
	case *pango.Panorama:
